...
mod tests {
    ...
    fn test_rehydrate_registers_worktree_in_db() {
        ...
        // Isolate the worktree DB (lock + INTELEKT_HOME → private tmp + restore).
        ...
        // global INTELEKT_HOME) DB and INSERT-OR-REPLACE our row.
        ...
        // other subagent rows since INTELEKT_HOME is process-global.
