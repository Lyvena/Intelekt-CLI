...
use fs2::FileExt;
use intelekt_workspace::util::is_lock_contended;
...
/// `~/.intelekt/leader.sock` — e.g. run a local branch build's leader without
...
mod tests {
    ...
    fn override_socket_path_wins_over_ws_url_derivation() {
        let root = Path::new("/home/u/.intelekt");
        let override_sock = PathBuf::from("/home/u/.intelekt/leader-branch.sock");
        ...
        assert_eq!(
            ...
            PathBuf::from("/home/u/.intelekt/leader-branch.lock")
        );
    }
