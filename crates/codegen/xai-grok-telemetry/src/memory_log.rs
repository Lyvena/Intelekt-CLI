...
//! file logger that writes to `~/.intelekt/logs/memory.log`.
//!
//! ## When to use
//!
...
//! tail -f ~/.intelekt/logs/memory.log      # watch in another terminal
//! ```
...
mod inner {
    ...
    ///
    /// Writes to `~/.intelekt/logs/memory.log`. Filters to `xai_memory=trace`.
