...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "intelekt-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "intelekt-3", "researcher");
    ...
    let shared_models = ["intelekt-3", "intelekt-3-mini"];
