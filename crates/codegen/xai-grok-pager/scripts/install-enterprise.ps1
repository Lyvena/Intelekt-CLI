#
# Intelekt CLI installer (enterprise channel) for PowerShell — https://x.ai/cli/enterprise-install.ps1
#
...
#   $env:INTELEKT_DEPLOYMENT_KEY="<key>"; irm https://x.ai/cli/enterprise-install.ps1 | iex
#
