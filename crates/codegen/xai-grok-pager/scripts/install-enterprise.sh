#!/bin/bash
#
# Intelekt CLI installer (enterprise channel) — https://x.ai/cli/enterprise-install.sh
#
...
# Env: INTELEKT_BIN_DIR, INTELEKT_PROXY_URL
#
# Usage:
...
#   INTELEKT_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://x.ai/cli/enterprise-install.sh)
#
...
if [ "$os" = "windows" ]; then
    ...
    chmod +x "$binary_path"
    ln -sf "$binary_path" "$BIN_DIR/intelekt"
