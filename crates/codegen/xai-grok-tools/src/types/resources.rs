...
/// tool falls back to `Cwd/.intelekt/plan.md`.
#[derive(Debug, Clone)]
...
pub const PLAN_FILE_RELATIVE_PATH: &str = ".intelekt/plan.md";
...
/// [`Cwd`]`/.intelekt/plan.md`, else the bare relative `.intelekt/plan.md`.
...
/// depending on `intelekt-mcp` directly.  Follows the same pattern as
